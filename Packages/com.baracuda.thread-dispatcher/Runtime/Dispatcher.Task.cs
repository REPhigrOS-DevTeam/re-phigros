...
namespace Baracuda.Threading
{
    public sealed partial class Dispatcher
    {
        ...
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task">Documentation</a></footer>
        public static void Invoke(Func<CancellationToken, Task> function, CancellationToken ct,
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task">Documentation</a></footer>
        public static Task InvokeAsync(Func<CancellationToken, Task> function, CancellationToken ct,
            bool throwOnCancellation = true)
        {
            var tcs = new TaskCompletionSource();
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task">Documentation</a></footer>
        public static Task InvokeAsync(Func<CancellationToken, Task> function, ExecutionCycle cycle,
        ...
        /// <param name="ct"></param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#taskTResult">Documentation</a></footer>
        public static Task<TResult> InvokeAsync<TResult>(Func<CancellationToken, Task<TResult>> function,
            CancellationToken ct)
        {
            var tcs = new TaskCompletionSource<TResult>();
