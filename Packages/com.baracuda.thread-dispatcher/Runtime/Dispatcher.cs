...
namespace Baracuda.Threading
{
    ...
    public sealed partial class Dispatcher : MonoBehaviour
    {
        ...
        [Space] [Tooltip("Determine the runtime hide flags for the dispatcher scene object")] [SerializeField]
        private HideFlags runtimeHideFlags = HideFlags.HideInHierarchy;

        [Tooltip("Enable / Disable execution of dispatched work during FixedUpdate")] [SerializeField]
        private bool enableFixedUpdate = false;

        [Tooltip("Enable / Disable execution of dispatched work during Update")] [SerializeField]
        private bool enableUpdate = true;

        [Tooltip("Enable / Disable execution of dispatched work during LateUpdate")] [SerializeField]
        private bool enableLateUpdate = true;
        ...
        public static void GuardAgainstIsNotMainThread(string methodCall)
        {
            if (!IsMainThread())
            {
                throw new InvalidOperationException(
                    $"{methodCall} is only allowed to bne called from the main thread!");
            }
        }
