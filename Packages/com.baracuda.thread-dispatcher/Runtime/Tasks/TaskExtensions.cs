...
namespace Baracuda.Threading.Tasks
{
    ...
    public static class TaskExtensions
    {
        ...
        /// is thrown if the target task does not complete within the set timeframe.
        /// </summary>
        public static Task TimeoutAsync(this Task mightTimeout, TimeSpan timeoutTimeSpan,
            CancellationToken ct = default)
        {
        ...
        /// </summary>
        public static async Task<TResult> IgnoreExceptionAsync<TException, TResult>(this Task<TResult> task,
            TResult defaultValue = default) where TException : Exception
        {
            try
            {
                return await task;
        ...
        /// <see cref="Task{TResult}"/> if an exception occurs.
        /// </summary>
        public static async Task<TResult> IgnoreExceptionsAsync<TResult>(this Task<TResult> task,
        ...
        /// <see cref="Task{TResult}"/> if an exception occurs.
        /// </summary>
        public static async Task<TResult> IgnoreTimeoutExceptionAsync<TResult>(this Task<TResult> task,
            TResult defaultValue = default)
        ...
        /// <see cref="Task{TResult}"/> if an exception occurs.
        /// </summary>
        public static async Task<TResult> IgnoreOperationCanceledExceptionAsync<TResult>(this Task<TResult> task,
            TResult defaultValue = default)
        ...
        /// <see cref="Task{TResult}"/> if an exception occurs.
        /// </summary>
        public static async Task<TResult> IgnoreThreadAbortExceptionAsync<TResult>(this Task<TResult> task,
            TResult defaultValue = default)
