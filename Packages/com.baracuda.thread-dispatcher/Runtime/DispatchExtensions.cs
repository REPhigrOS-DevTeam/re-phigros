...
namespace Baracuda.Threading
{
    ...
    public static class DispatchExtensions
    {
        ...
        public static Task DispatchAsync(this Action action, CancellationToken ct, bool throwOnCancellation = true,
            bool nullCheck = true)
        {
            return nullCheck && action == null
                ? Task.CompletedTask
                : Dispatcher.InvokeAsync(action, ct, throwOnCancellation);
        }
        ...
        /// <returns>Task that will complete on the calling thread after the passed action has been executed.</returns>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#actions-ext">Documentation</a></footer>
        public static Task DispatchAsync(this Action action, ExecutionCycle cycle, CancellationToken ct,
            bool throwOnCancellation = true, bool nullCheck = true)
        {
            return nullCheck && action == null
                ? Task.CompletedTask
                : Dispatcher.InvokeAsync(action, cycle, ct, throwOnCancellation);
        }
        ...
        /// <exception cref="InvalidOperationException"> exception is thrown if an <see cref="IEnumerator"/> is dispatched during edit mode.</exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutine-completion">Documentation</a></footer>
        public static Task DispatchAsyncAwaitCompletion(this IEnumerator enumerator, CancellationToken ct,
        ...
        public static Task DispatchAsyncAwaitCompletion(this IEnumerator enumerator, MonoBehaviour target,
            bool throwExceptions = true)
        {
        ...
        /// <exception cref="InvalidOperationException"> exception is thrown if an <see cref="IEnumerator"/> is dispatched during edit mode.</exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutine-completion">Documentation</a></footer>
        public static Task DispatchAsyncAwaitCompletion(this IEnumerator enumerator, ExecutionCycle cycle,
            bool throwExceptions = true)
        {
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task">Documentation</a></footer>
        public static void Dispatch(this Func<CancellationToken, Task> function, CancellationToken ct,
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task">Documentation</a></footer>
        public static void Dispatch(this Func<CancellationToken, Task> function, ExecutionCycle cycle,
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task-async">Documentation</a></footer>
        public static Task DispatchAsync(this Func<CancellationToken, Task> function, CancellationToken ct,
            bool throwOnCancellation = true)
        {
        ...
        /// <param name="throwOnCancellation"> </param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task-async">Documentation</a></footer>
        public static Task DispatchAsync(this Func<CancellationToken, Task> function, ExecutionCycle cycle,
            CancellationToken ct, bool throwOnCancellation = true)
        {
        ...
        /// <param name="ct"></param>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#task-TResult">Documentation</a></footer>
        public static Task<TResult> DispatchAsync<TResult>(this Func<CancellationToken, Task<TResult>> function,
            CancellationToken ct)
        {
