...
namespace Baracuda.Threading
{
    public sealed partial class Dispatcher : IDisableCallback
    {
        ...
        /// <exception cref="InvalidOperationException"> exception is thrown if an <see cref="IEnumerator"/> is dispatched during edit mode.</exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines-async">Documentation</a></footer>
        public static Task InvokeAsyncAwaitCompletion(IEnumerator enumerator, CancellationToken ct,
        ...
        /// <exception cref="InvalidOperationException"> exception is thrown if an <see cref="IEnumerator"/> is dispatched during edit mode.</exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines-async">Documentation</a></footer>
        public static Task InvokeAsyncAwaitCompletion(IEnumerator enumerator, MonoBehaviour target,
            bool throwExceptions = true)
        {
            var tcs = new TaskCompletionSource();
        ...
        /// <exception cref="InvalidOperationException"> exception is thrown if an <see cref="IEnumerator"/> is dispatched during edit mode.</exception>
        /// <footer><a href="https://johnbaracuda.com/dispatcher.html#coroutines-async">Documentation</a></footer>
        public static Task InvokeAsyncAwaitCompletion(IEnumerator enumerator, ExecutionCycle cycle,
            bool throwExceptions = true)
        {
            var tcs = new TaskCompletionSource();
        ...
        {
            Invoke(() => { Current.StopCoroutine(coroutine); });
        }
        ...
        public static Task CancelCoroutineAsync(Coroutine coroutine, CancellationToken ct,
        ...
        private static void StartCoroutineInternal(IEnumerator coroutine, TaskCompletionSource tcs,
            CancellationToken ct, bool throwExceptions, MonoBehaviour target)
        {
            if (throwExceptions)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void StartCoroutineInternal(IEnumerator coroutine, TaskCompletionSource tcs,
            CancellationToken ct, bool throwExceptions)
        {
            if (throwExceptions)
            {
                Current.StartCoroutineExceptionSensitive(coroutine, tcs.TrySetException, tcs.TrySetCompleted, ct,
                    current);
            }
            else
            {
