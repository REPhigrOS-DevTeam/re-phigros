...
{
    public class LoginManagerOld : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (RememberMe)
            {
                ifUsername.text = username = GlobalSetting.username;
        ...
        private void OnInputFieldsClicked(bool a)
        {
            ...
            GlobalSetting.username = GlobalSetting.verifyToken = "";
            firstLogin = false;
        ...
        public static async Task<StatusCode> Login(string username, string password)
        {
            ...
            GlobalSetting.username = username;
            GlobalSetting.verifyToken = res.verifyToken;
        ...
        public static async Task<StatusCode> Verify()
        {
...
#endif
            if (GlobalSetting.username == "" || GlobalSetting.verifyToken == "")
            {
            ...
            {
                Query = $"username={GlobalSetting.username}&verifytoken={GlobalSetting.verifyToken}"
            };
            string uri = builder.Uri.ToString();
#if UNITY_EDITOR
        ...
        {
            PlayerPrefs.SetString("repapi_playername", GlobalSetting.username);
            PlayerPrefs.SetString("repapi_verifytoken", GlobalSetting.verifyToken);
            PlayerPrefs.Save();
        }
        ...
        public static void ReadAccountFromPlayerPrefs(bool refresh = false)
        {
            ...
            if (RememberMe)
            {
                GlobalSetting.username = PlayerPrefs.GetString("repapi_playername", "");
                GlobalSetting.verifyToken = PlayerPrefs.GetString("repapi_verifytoken", "");
            }
            else if (refresh)
            {
                GlobalSetting.username = "";
