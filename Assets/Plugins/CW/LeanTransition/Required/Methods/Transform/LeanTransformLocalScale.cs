...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localScale" +
    ...
    public class LeanTransformLocalScale : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.localScale != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET localScaleTransition(this TARGET target, UnityEngine.Vector3 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformLocalScale.Register(target, value, duration, ease);
            return target;
        }
    }
}