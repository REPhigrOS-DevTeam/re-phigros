...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localPosition" +
    ...
    public class LeanTransformLocalPosition : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.localPosition != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET localPositionTransition(this TARGET target, UnityEngine.Vector3 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformLocalPosition.Register(target, value, duration, ease);
            return target;
        }
    }
}