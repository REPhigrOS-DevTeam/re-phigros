...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.position.xy" +
    ...
    public class LeanTransformPosition_xy : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && (Target.position.x != Value.x || Target.position.y != Value.y) ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET positionTransition_xy(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformPosition_xy.Register(target, value, duration, ease);
            return target;
        }
    }
}