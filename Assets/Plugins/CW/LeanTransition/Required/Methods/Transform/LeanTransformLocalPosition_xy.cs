...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localPosition.xy" +
    ...
    public class LeanTransformLocalPosition_xy : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            public override int CanFill
            {
                get
                {
                    return Target != null && (Target.localPosition.x != Value.x || Target.localPosition.y != Value.y)
                        ? 1
                        : 0;
                }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET localPositionTransition_xy(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformLocalPosition_xy.Register(target, value, duration, ease);
            return target;
        }
    }
}