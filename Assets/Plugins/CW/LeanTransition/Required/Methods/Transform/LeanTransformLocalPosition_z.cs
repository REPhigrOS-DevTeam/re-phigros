...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localPosition.z" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanTransformLocalPosition_z)")]
    public class LeanTransformLocalPosition_z : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.localPosition.z != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanTransformLocalPosition_z.Register(target, value, duration, ease);
            return target;
        }
    }
}