...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.position.z" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanTransformPosition_Z)")]
    public class LeanTransformPosition_Z : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.position.z != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanTransformPosition_Z.Register(target, value, duration, ease);
            return target;
        }
    }
}