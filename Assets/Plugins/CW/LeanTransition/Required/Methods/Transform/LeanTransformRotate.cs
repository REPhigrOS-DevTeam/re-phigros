...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        public static Transform RotateTransition(this Transform target, float x, float y, float z, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformRotate.Register(target, new Vector3(x, y, z), Space.Self, duration, ease);
            return target;
        }
        ...
        public static Transform RotateTransition(this Transform target, Vector3 eulerAngles, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformRotate.Register(target, eulerAngles, Space.Self, duration, ease);
            return target;
        }
        ...
        {
            Method.LeanTransformRotate.Register(target, new Vector3(x, y, z), space, duration, ease);
            return target;
        }
        ...
        public static Transform RotateTransition(this Transform target, Vector3 eulerAngles, Space space,
            float duration, LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformRotate.Register(target, eulerAngles, space, duration, ease);
            return target;
        }
    }
}