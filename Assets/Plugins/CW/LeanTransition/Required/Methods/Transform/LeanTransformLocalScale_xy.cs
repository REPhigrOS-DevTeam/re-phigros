...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localScale.xy" +
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET localScaleTransition_xy(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformLocalScale_xy.Register(target, value, duration, ease);
            return target;
        }
    }
}