...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.position.x" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanTransformPosition_X)")]
    public class LeanTransformPosition_X : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.position.x != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanTransformPosition_X.Register(target, value, duration, ease);
            return target;
        }
    }
}