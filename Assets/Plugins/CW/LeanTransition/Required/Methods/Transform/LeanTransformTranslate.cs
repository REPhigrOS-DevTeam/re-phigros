...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        public static Transform TranslateTransition(this Transform target, float x, float y, float z, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformTranslate.Register(target, new Vector3(x, y, z), Space.Self, duration, ease);
            return target;
        }
        ...
        public static Transform TranslateTransition(this Transform target, Vector3 translation, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformTranslate.Register(target, translation, Space.Self, duration, ease);
            return target;
        }
        ...
        {
            Method.LeanTransformTranslate.Register(target, new Vector3(x, y, z), space, duration, ease);
            return target;
        }
        ...
        public static Transform TranslateTransition(this Transform target, Vector3 translation, Space space,
            float duration, LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformTranslate.Register(target, translation, space, duration, ease);
            return target;
        }
        ...
        {
            Method.LeanTransformTranslate.Register(target, new Vector3(x, y, z), relativeTo, duration, ease);
            return target;
        }
        ...
        public static Transform TranslateTransition(this Transform target, Vector3 translation, Transform relativeTo,
            float duration, LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanTransformTranslate.Register(target, translation, relativeTo, duration, ease);
            return target;
        }
    }
}