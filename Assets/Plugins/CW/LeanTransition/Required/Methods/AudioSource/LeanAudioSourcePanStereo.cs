...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "AudioSource/AudioSource.panStereo" +
    ...
    public class LeanAudioSourcePanStereo : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [UnityEngine.Tooltip("The panStereo value will transition to this.")] [UnityEngine.Range(-1.0f, 1.0f)]
            public float Value;
            ...
            {
                get { return Target != null && Target.panStereo != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanAudioSourcePanStereo.Register(target, value, duration, ease);
            return target;
        }
    }
}