...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "AudioSource/AudioSource.spatialBlend" +
    ...
    public class LeanAudioSourceSpatialBlend : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [UnityEngine.Tooltip("The spatialBlend value will transition to this.")] [UnityEngine.Range(0.0f, 1.0f)]
            ...
            {
                get { return Target != null && Target.spatialBlend != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanAudioSourceSpatialBlend.Register(target, value, duration, ease);
            return target;
        }
    }
}