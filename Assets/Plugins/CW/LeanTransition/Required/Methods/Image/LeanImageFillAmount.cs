...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Image/Image.fillAmount" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanImageFillAmount)")]
    public class LeanImageFillAmount : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.fillAmount != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanImageFillAmount.Register(target, value, duration, ease);
            return target;
        }
    }
}