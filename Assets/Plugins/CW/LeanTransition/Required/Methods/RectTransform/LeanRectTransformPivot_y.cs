...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.pivot.y" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanRectTransformPivot_y)")]
    public class LeanRectTransformPivot_y : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.pivot.y != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanRectTransformPivot_y.Register(target, value, duration, ease);
            return target;
        }
    }
}