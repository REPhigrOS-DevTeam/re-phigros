...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.offsetMin" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanRectTransformOffsetMin)")]
    public class LeanRectTransformOffsetMin : LeanMethodWithStateAndTarget
    {
        ...
        public static LeanState Register(TARGET target, UnityEngine.Vector2 value, float duration,
        ...
        {
            public static System.Collections.Generic.Stack<State> Pool = new System.Collections.Generic.Stack<State>();
            ...
            {
                get { return Target != null && Target.offsetMin != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET offsetMinTransition(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanRectTransformOffsetMin.Register(target, value, duration, ease);
            return target;
        }
    }
}