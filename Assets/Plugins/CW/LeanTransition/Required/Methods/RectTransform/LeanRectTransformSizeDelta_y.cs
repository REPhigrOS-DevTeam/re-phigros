...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.sizeDelta.y" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanRectTransformSizeDelta_y)")]
    public class LeanRectTransformSizeDelta_y : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.sizeDelta.y != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanRectTransformSizeDelta_y.Register(target, value, duration, ease);
            return target;
        }
    }
}