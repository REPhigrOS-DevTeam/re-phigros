...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.anchoredPosition" +
    ...
    public class LeanRectTransformAnchoredPosition : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.anchoredPosition != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET anchoredPositionTransition(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanRectTransformAnchoredPosition.Register(target, value, duration, ease);
            return target;
        }
    }
}