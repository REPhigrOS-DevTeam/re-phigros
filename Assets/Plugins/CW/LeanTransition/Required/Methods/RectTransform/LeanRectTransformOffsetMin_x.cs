...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.offsetMin.x" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanRectTransformOffsetMin_x)")]
    public class LeanRectTransformOffsetMin_x : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.offsetMin.x != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanRectTransformOffsetMin_x.Register(target, value, duration, ease);
            return target;
        }
    }
}