...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.anchorMax.x" +
    ...
    public class LeanRectTransformAnchorMax_x : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.anchorMax.x != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanRectTransformAnchorMax_x.Register(target, value, duration, ease);
            return target;
        }
    }
}