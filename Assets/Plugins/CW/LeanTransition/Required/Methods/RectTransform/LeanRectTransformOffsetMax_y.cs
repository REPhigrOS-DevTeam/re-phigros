...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.offsetMax.y" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanRectTransformOffsetMax_y)")]
    public class LeanRectTransformOffsetMax_y : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.offsetMax.y != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanRectTransformOffsetMax_y.Register(target, value, duration, ease);
            return target;
        }
    }
}