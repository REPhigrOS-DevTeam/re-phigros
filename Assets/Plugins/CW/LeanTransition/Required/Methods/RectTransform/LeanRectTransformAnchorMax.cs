...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.anchorMax" +
    ...
    public class LeanRectTransformAnchorMax : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.anchorMax != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET anchorMaxTransition(this TARGET target, UnityEngine.Vector2 value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanRectTransformAnchorMax.Register(target, value, duration, ease);
            return target;
        }
    }
}