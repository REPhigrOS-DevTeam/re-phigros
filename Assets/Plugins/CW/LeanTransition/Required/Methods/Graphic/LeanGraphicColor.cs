...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Graphic/Graphic.color" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanGraphicColor)")]
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        public static TARGET colorTransition(this TARGET target, UnityEngine.Color value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanGraphicColor.Register(target, value, duration, ease);
            return target;
        }
    }
}