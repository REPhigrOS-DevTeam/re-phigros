...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Light/Light.range" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanLightRange)")]
    public class LeanLightRange : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.range != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    public static partial class LeanExtensions
    {
        ...
        {
            Method.LeanLightRange.Register(target, value, duration, ease);
            return target;
        }
    }
}