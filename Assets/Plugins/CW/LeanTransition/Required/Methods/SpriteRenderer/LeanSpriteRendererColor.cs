...
namespace Lean.Transition.Method
{
    ...
    [UnityEngine.AddComponentMenu(LeanTransition.MethodsMenuPrefix + "SpriteRenderer/SpriteRenderer.color" +
                                  LeanTransition.MethodsMenuSuffix + "(LeanSpriteRendererColor)")]
    public class LeanSpriteRendererColor : LeanMethodWithStateAndTarget
    {
        ...
        public static LeanState Register(TARGET target, UnityEngine.Color value, float duration,
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            {
                get { return Target != null && Target.color != Value ? 1 : 0; }
            }
...
namespace Lean.Transition
{
    ...
    {
        public static TARGET colorTransition(this TARGET target, UnityEngine.Color value, float duration,
            LeanEase ease = LeanEase.Smooth)
        {
            Method.LeanSpriteRendererColor.Register(target, value, duration, ease);
            return target;
        }
    }
}