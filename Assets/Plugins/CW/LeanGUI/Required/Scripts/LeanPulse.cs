...
namespace Lean.Gui
{
    ...
    public class LeanPulse : MonoBehaviour
    {
        ...
        [SerializeField] private IntEvent onPulse;

        [System.NonSerialized] private LinkedListNode<LeanPulse> link;
        ...
        public IntEvent OnPulse
        {
            get
            {
                if (onPulse == null) onPulse = new IntEvent();
                return onPulse;
            }
        }
